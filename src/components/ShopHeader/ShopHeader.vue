<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showShopContent=!showShopContent">
...
<span class="content-tag">
    ...
    <div class="shop-header-discounts" @click="isShowActivitySheet=!isShowActivitySheet" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showShopContent">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showShopContent =false">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="isShowActivitySheet" v-if="info.supports">
      ...
      .activity-sheet-content{
        ...
        .list{
          ...
          .activity-item{
            ...
            align-items: center;
            &.activity-green{
              .content-tag{background-color: rgb(112, 188, 70)}
            }
            &.activity-red{
              .content-tag{background-color: rgb(240, 115, 115)}
            }
            &.activity-orange{
              .content-tag{background-color: rgb(241, 136, 79)}
            }
            .content-tag{

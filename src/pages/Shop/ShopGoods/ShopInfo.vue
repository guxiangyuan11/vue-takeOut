  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item activity-green" :class="activityClass[support.type]"
...
<script>
    ...
    export default{
        ...
        methods: {
          _initScroll(){
            new BScroll('.shop-info', { // 初始化商家信息页面滚动
              click: true
            })
            // 计算横向滚动的宽度
            const liWidth = 120
            const space = 6
            const allWidth = (liWidth+space) * this.info.pics.length - space
            this.$refs.picList.style.width = allWidth + 'px'
            new BScroll('.pic-wrapper', { // 初始化商家图片横向滚动
              scrollX: true
            })
          }
        },
